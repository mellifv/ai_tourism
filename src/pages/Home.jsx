      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div whileHover={{ y: -6 }} className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/5">
            ...
            <p className="text-sm text-slate-300 mb-4">{t('features.videoGuidesDesc', "Short, actionable video routes for the city's best photo spots and transit tips.")}</p>
          ...
          <motion.div whileHover={{ y: -6 }} className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/5">
            ...
            <p className="text-sm text-slate-300 mb-4">{t('features.itinerariesDesc', 'Generate half-day or full-day plans tuned to budget and interests (coming soon).')}</p>
          ...
          <motion.div whileHover={{ y: -6 }} className="p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/5">
            ...
            <p className="text-sm text-slate-300 mb-4">{t('features.cityInsightsDesc', 'Local tips, transit maps, and the best times to visit top sights.')}</p>
